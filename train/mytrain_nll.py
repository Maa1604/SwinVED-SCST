...
for epoch in range(epochs):
    ...
    metrics_table = Evaluator.metrics_to_log(evaluator.evaluation_report, train_loss, test_loss, train_hnm_loss, optimizer.param_groups[0]['lr'])
    ...
    # if best_f1_chexbert < evaluator.evaluation_report['F1 ChexBert']:
    #     try:
    #         os.remove(EXP_DIR_PATH + "/best_f1_chexbert_" + str(epoch_best_f1_chexbert) + "_model.pt")
    #     except OSError as e:
    #         print("No se ha eliminado nada")
    #     best_f1_chexbert = evaluator.evaluation_report['F1 ChexBert']
